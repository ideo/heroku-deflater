...
module HerokuDeflater
  class Railtie < Rails::Railtie
    ...
    # Set default Cache-Control headers to 1 year.
    # The configuration block in config/application.rb overrides this (or does it?).
    config.before_initialize do |app|
      cache_control = cache_control_manager(app)
      cache_control.setup_max_age(31536000)
    end
